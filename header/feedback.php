...
<body>
    ...
    <section class="parallax section-1-feedback">
        <h1 class="feedback">Feedback</h1>

    </section>

    <section class="parallax section-2-feedback">
        <?php
        ...
        <form method="POST">
            ...
            <button name="enviar-feedback" type="submit">Enviar</button>
        ...
        <div>
            ...
            <p>Seu comentário será enviado de forma totalmente anônima!</p>
        </div>
    </section>
