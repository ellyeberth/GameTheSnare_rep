...
<body>
    ...
    <section class="parallax section-2-niveis">
        <section class="central">
            <h2>Testing Player</h2>
            <h3>
                Olá jogador, seja bem vindo a área de explicação de cada nível. Este primeiro nível é apenas um teste para
                sabermos se você é apto a desvendar os mistérios do <b>THE SNARE</b>. Este nível é bastante simples e queremos ver
                como é seu desempenho nele. O jogo está em Inglês porém acredito que você sairá bem nessa. Boa sorte!
            </h3>
