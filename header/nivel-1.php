...
<body>
    ...
    <section class="parallax section-2-niveis">
        <section class="central">
            <h2>Where's the white?</h2>
            <h3>
                Procure o botão e você conseguirá ir para o próximo nível. Este nível não é difícil e você passaram de
                fase, porém lembre-se que os níveis estão interligados, ou seja, as respostas para esse e para outros
                podem estar em qualquer lugar. Há várias dicas em torno da própria tela, e você precisa saber a maneira
                certa de usá-las. O jogo está em Inglês porém acredito que você sairá bem nessa. Boa sorte!
            </h3>
