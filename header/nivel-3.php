...
<body>
    ...
    <section class="parallax section-2-niveis">
        <section class="central">
            <h2>No Crying</h2>
            <h3>
                Este nível consiste em você observar a imagem e o áudio principal da página e descobrir que música está
                tocando. Há várias dicas e pistas em torno da própria tela, e você precisa saber a maneira certa de
                usá-las. É um nível bem simples, porém você vai precisar ter paciência e atenção. Você pode usar o
                Google para fazer suas pesquisas ou usar o Código-Fonte da página para alcançar o Nível 3.
            </h3>
